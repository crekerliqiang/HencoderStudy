    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(direction == 0)imageView.animate().translationX(dpToPixel(200)).setDuration(duration);
                if(direction == 1)imageView.animate().translationX(dpToPixel(0)).setDuration(duration);
                direction++;
