    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                switch (angle){
                    case 0:imageView.animate().rotationX(180);break;
                    case 1:imageView.animate().rotationX(0);break;
                    case 2:imageView.animate().rotationY(180);break;
                    case 3:imageView.animate().rotationY(0);break;
