...
public class Practice14FlipboardView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final int x = centerX - bitmapWidth / 2;
        final int y = centerY - bitmapHeight / 2;
        ...
        paint.reset();
        final int x2 = getWidth() / 4 * 3;
        //绘制右边
        canvas.save();
        canvas.clipRect(x2 + bitmapWidth / 2, 0, getWidth() , getHeight());
        canvas.drawBitmap(bitmap, x2, y, paint);
        canvas.restore();
        //绘制左边 TODO
