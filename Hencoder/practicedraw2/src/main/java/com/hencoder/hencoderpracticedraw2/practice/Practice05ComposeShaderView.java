...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Bitmap dstBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.batman);
        Bitmap srcBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.batman_logo);
        BitmapShader dstShader = new BitmapShader(dstBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        BitmapShader srcShader = new BitmapShader(srcBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
