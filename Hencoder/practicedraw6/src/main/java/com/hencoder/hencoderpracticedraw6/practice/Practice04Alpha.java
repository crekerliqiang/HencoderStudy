    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                switch (alpha){
                    case 0:imageView.animate().alpha(0f);break;
                    case 1:imageView.animate().alpha(0.3f);break;
                    case 2:imageView.animate().alpha(0.6f);break;
                    case 3:imageView.animate().alpha(0.8f);break;
                    case 4:imageView.animate().alpha(1f);break;
                }
                alpha++;
                if(alpha > 4){
                    alpha = 0;
