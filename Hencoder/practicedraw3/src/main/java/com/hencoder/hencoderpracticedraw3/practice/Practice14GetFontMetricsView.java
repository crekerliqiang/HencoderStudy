...
public class Practice14GetFontMetricsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(texts[0], 100, middle + y, paint2);
        canvas.drawText(texts[1], 200, middle + y, paint2);
        canvas.drawText(texts[2], 300, middle + y, paint2);
        canvas.drawText(texts[3], 400, middle + y, paint2);
        canvas.drawText(texts[4], 500, middle + y, paint2);
        canvas.drawText(texts[5], 600, middle + y, paint2);
    }
}
